...
var secondpassword=document.f1.passwordr.value;  
...
alert("password must be same! & Atleast 6 characters long.....");  
return false;  
}  
}  
</script> 
...
<form name="f1" method="post" action="save1" onsubmit="return matchpass()">
  <div class="container">
    <h1>Register</h1>
